...
"""
View layer.
Builds the entire Gradio UI layout.
...
def build_ui() -> gr.Blocks:
    ...
    ) if all_videos else "⚠️ No videos found"
    ...
    with gr.Blocks(title="Video Annotator") as app:
        ...
        with gr.Accordion("📋 Available Videos", open=False):
            gr.Markdown(video_list_md)
        ...
        with gr.Row():
            with gr.Column(scale=1):
                ...
                # gr.Row in outputs causes a clean, instant toggle
                # with no spinner (unlike gr.Column / gr.Group).
        ...
        # ── Delete flow ────────────────────────────────────────
        # Step 1: populate HTML + lock ID in .click()
        # Step 2: show/hide btn_row in .then() — no spinner
        ...
        confirm_btn.click(
            ...
            outputs = [
                ...
                preview_video,
                preview_info,
                confirm_html,        # clear html
                confirm_id_state,    # clear id
            ]
        ).then(
